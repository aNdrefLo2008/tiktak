    ...
    <div className='w-full flex justify-between items-center border-b-2 border-gray-200 py-2 px-4'>
      <Link href="/">
        <div className='w-[100px] md:w-[130px]'>
          <Image className='cursor-pointer' src={Logo} alt="TikTak" layout='responsive'/>
        </div>
      </Link>

      <div className='relative hidden md:block'>
        <form onSubmit={handleSearch} className="absolute md:static top-10 -left-20 bg-white">
          <input type="text" value={searchValue} onChange={(e) => {setSearchValue(e.target.value)}} className="bg-primary p-3 font-medium border-2 border-gray-100 focus:outline-none focus:border-gray-300 md:w-[350px] w-[300px] rounded-full" placeholder="Search account and videos"/>
        ...
        {userProfile ? (
          <div className='flex gap-5 md:gap-10'>
            ...
            <button onClick={() => {
              googleLogout()
              removeUser()
              }} type='button' className='px-2 rounded-full border-[1px] shadow-md'>
